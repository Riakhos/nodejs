...
const Article = memo(() => {
    ...
    useEffect(() => {
        ...
        if (!article || article._id !== id) {
            ...
            const fetchArticleById = async () => {
                try {
                    const { data } = await axios.get(`https://richard.bonnegent.fr/nodejs/api/article/get/${id}`)
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            // Suppression via API
            await axios.delete(`https://richard.bonnegent.fr/nodejs/api/article/delete/${id}`)
