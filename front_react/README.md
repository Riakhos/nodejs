...
Lance le lanceur de tests en mode interactif de surveillance.\
...
**Remarque : cette opération est irréversible. Une fois que vous `eject`, vous ne pouvez pas revenir en arrière !**

Si vous n'êtes pas satisfait des choix d'outils de construction et de configuration, vous pouvez `eject` à tout moment. Cette commande supprimera la dépendance de construction unique de votre projet.
